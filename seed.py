...
with app.app_context():
    ...
    alice = Person(name='Alice Chen', email='alice@example.com', team_id=engineering.id, workspace_id=ws1.id)
    bob = Person(name='Bob Martinez', email='bob@example.com', team_id=engineering.id, workspace_id=ws1.id)
    carol = Person(name='Carol Johnson', email='carol@example.com', team_id=design.id, workspace_id=ws1.id)
    dave = Person(name='Dave Kim', email='dave@example.com', team_id=design.id, workspace_id=ws1.id)
    frank = Person(name='Frank Lee', email='frank@example.com', team_id=engineering.id, workspace_id=ws1.id)
    ...
    eve = Person(name='Eve Williams', email='eve@example.com', team_id=mkt_team.id, workspace_id=ws2.id)
    grace = Person(name='Grace Park', email='grace@example.com', team_id=creative_team.id, workspace_id=ws2.id)
    henry = Person(name='Henry Osei', email='henry@example.com', team_id=mkt_team.id, workspace_id=ws2.id)
